      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 md:p-8 shadow-sm">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div>
              <label className="text-sm font-semibold text-gray-700 block mb-2 select-none">
                Test Type
              </label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Input
                label="Name of Test"
                placeholder="E.g. Electrostatics Practice Test"
            ...
            <div className="border border-gray-150 rounded-xl p-5 md:p-6 bg-gray-50 flex flex-wrap gap-6 items-end justify-between">
              ...
              {/* Readonly Total Marks */}
              <div className="flex flex-col gap-1.5 min-w-[120px]">
                <label className="text-sm font-semibold text-gray-400 select-none">Total Marks</label>
                <div className="flex items-center justify-center rounded-lg border border-gray-200 bg-gray-250 h-[42px] px-6 font-bold text-gray-500 select-none">
                  {totalMarksValue}
                </div>
              </div>
            </div>
